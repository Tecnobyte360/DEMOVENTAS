...
<div class="relative p-8 md:p-10 rounded-3xl shadow-2xl
    ...
    <div aria-hidden="true"
        class="pointer-events-none absolute -top-24 -right-24 w-72 h-72 rounded-full bg-indigo-400/20 blur-3xl"></div>
    <div aria-hidden="true"
        class="pointer-events-none absolute -bottom-20 -left-20 w-96 h-96 rounded-full bg-violet-400/20 blur-3xl"></div>
        ...
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="text-2xl md:text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white flex items-center gap-3">
                    ...
                    ConfiguraciÃƒÆ’Ã‚³n de Empresas
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    Gestiona nombre, logos y datos bÃƒÆ’Ã‚¡sicos. Personaliza colores, tema PDF, estado y bodega predeterminada.
                </p>
            </div>
        </div>
    </div>

    {{-- Alertas de ÃƒÆ’Ã‚©xito en propiedad --}}
    @if ($ok)
    ...
    {{-- Error general --}}
    @error('general')
        <div class="relative z-10 mb-6 rounded-2xl border border-red-300/60 bg-red-50 text-red-800 px-4 py-3 text-sm
                dark:bg-red-900/30 dark:text-red-200 dark:border-red-700/60">
            <div class="flex items-start gap-3">
                <span class="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-lg bg-red-500/10 text-red-600 dark:text-red-300">
        ...
        <div class="lg:col-span-2 space-y-7 max-w-6xl mx-auto w-full">
            ...
            <div class="bg-white/80 dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">TelÃƒÆ’Ã‚©fono</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                            <i class="fa-brands fa-whatsapp text-green-500 mr-1"></i> WhatsApp
                        </label>
                        <input type="text" wire:model.defer="whatsapp"
                            class="mt-1 w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                            placeholder="+57 300 000 0000">
                        @error('whatsapp')
                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">DirecciÃƒÆ’Ã‚³n</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select wire:model.defer="bodega_predeterminada_id"
                            class="mt-1 w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                        ...
                        @error('bodega_predeterminada_id')
                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                        @enderror

                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Esta bodega se usarÃƒÆ’Ã‚¡ por defecto al crear documentos o movimientos para esta empresa.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/80 dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
                <div class="mb-6 flex items-center gap-3">
                    <span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600/10 text-violet-600 dark:text-violet-400">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <input type="color"
                                class="h-10 w-10 rounded-lg cursor-pointer border border-gray-300 dark:border-gray-700"
                                x-model="theme.primary">
                            <input type="text" wire:model.defer="color_primario" x-model.lazy="theme.primary"
            ...
            {{-- Ã°Å¸â€™³ InformaciÃƒ³n de pago en documentos --}}
            <div class="bg-white/80 dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">InformaciÃƒ³n de pago</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">NÃƒºmero de cuenta</label>
            ...
            <div class="bg-white/80 dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
                ...
                {{-- Vista previa mini --}}
                <div class="mt-8">
                    <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">PrevisualizaciÃƒÆ’Ã‚³n</h4>
                    <div class="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow">
                        <div class="p-4"
                            ...
                            <div class="text-white/80 text-xs">N.Ãƒâ€šÃ‚º DEMO-000001</div>
                        </div>
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody>
                                    <tr :style="`border-bottom:1px solid ${theme.border}`">
                                        <td class="px-4 py-2">ArtÃƒÆ’Ã‚­culo A</td>
                                    ...
                                    <tr :style="`background:${theme.stripe}; border-bottom:1px solid ${theme.border}`">
                                        <td class="px-4 py-2">ArtÃƒÆ’Ã‚­culo B</td>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white/80 dark:bg-white/10 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
                ...
                <div class="group">
                    ...
                    <input type="file" accept="image/*" @change="toBase64($event, 'logoPreview', 'logo_b64')"
                ...
                <div class="group">
                    ...
                    <input type="file" accept="image/*" @change="toBase64($event, 'logoDarkPreview', 'logo_dark_b64')"
                        class="mt-1 block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 dark:file:bg-indigo-950 dark:file:text-indigo-200">
                    @error('logo_dark')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="group">
                    ...
                    <input type="file" accept="image/*,.ico" @change="toBase64($event, 'faviconPreview', 'favicon_b64')"
                        class="mt-1 block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 dark:file:bg-indigo-950 dark:file:text-indigo-200">
                    @error('favicon')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50/70 dark:bg-gray-800/40">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">TelÃƒÆ’Ã‚©fono</th>
                    ...
                    @forelse ($rows as $row)
                        <tr class="hover:bg-indigo-50/30 dark:hover:bg-gray-800/40 transition">
                            <td class="px-4 py-3">
                                ...
                                @else
                                    <div class="h-8 w-8 rounded-md bg-gray-200 dark:bg-gray-700 grid place-content-center text-xs text-gray-500">Ãƒ¢Ã¢â€š¬Ã¢â‚¬ï¿½</div>
                                @endif
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-gray-700 dark:text-gray-200">
                                {{ $row->bodegaPredeterminada->nombre ?? 'Ãƒ¢Ã¢â€š¬Ã¢â‚¬ï¿½' }}
                            </td>
                            <td class="px-4 py-3">
                                @if ($row->is_activa)
...
{{-- Alpine helper: lee archivo y envÃƒÆ’Ã‚­a Base64 al componente Livewire --}}
<script>
