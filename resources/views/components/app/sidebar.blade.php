        ...
        <nav class="flex-1 px-3 pb-4 overflow-y-auto sidebar-scrollbar">
            <div class="space-y-1">
                ...
                <div x-data="{ open: {{ in_array(Request::segment(1), ['ventas']) ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-8 space-y-1 lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <a href="{{ route('notascreditoclientes') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Nota crédito de ventas</span>
                        </a>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-8 space-y-1 lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <a href="{{ route('Notascreditocompra') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Nota crédito de compras</span>
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ in_array(Request::segment(1), ['ecommerce']) ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-8 space-y-1 lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <div x-data="{ openStock: false }">
                            ...
                            <div x-show="openStock" x-collapse class="mt-1 ml-4 space-y-1">
                                <a href="{{ route('Entradas') }}"
                                   ...
                                   :style="`color: ${fgMuted}`">
                                    <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                                    <span class="transition-all duration-200 group-hover:font-bold">Entradas de stock</span>
                                </a>
                                ...
                                <a href="{{ route('SalidaMercancia') }}"
                                   ...
                                   :style="`color: ${fgMuted}`">
                                    <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                                    <span class="transition-all duration-200 group-hover:font-bold">Salida mercancía</span>
                                </a>
                                ...
                                <a href="{{ route('DevolucionMercancia') }}"
                                   ...
                                   :style="`color: ${fgMuted}`">
                                    <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                                    <span class="transition-all duration-200 group-hover:font-bold">Devolución de mercancía</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <a href="{{ route('indexcategorias') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Categorías Artículos</span>
                        </a>
                        ...
                        <a href="{{ route('subcategorias.index') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">SubCategorías de artículos</span>
                        </a>
                        ...
                        <a href="{{ route('productos.index') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Productos inventariables</span>
                        </a>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-8 space-y-1 lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <a href="{{ route('asientos.index') }}"
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Informe diario contable</span>
                        </a>
                ...
                <!-- Divider -->
                <div class="py-3">
                    <div class="border-t" :style="`border-color: ${isLight ? '#cbd5e1' : 'rgba(255,255,255,.12)'}`"></div>
                </div>
                ...
                <div x-data="{ open: {{ in_array(Request::segment(1), ['settings']) ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-8 space-y-1 lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <a href="{{ route('Usuarios') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Usuarios</span>
                        </a>
                        <a href="{{ route('roles.index') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Roles</span>
                        </a>
                        <a href="{{ route('roles.index2') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Permisos</span>
                        </a>
                        <a href="{{ route('Empresas') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Empresas</span>
                        </a>
                        <a href="{{ route('SeriesDocumentos') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Series Documentos</span>
                        </a>
                        <a href="{{ route('normas-reparto.index') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Normas de Reparto</span>
                        </a>
                        <a href="{{ route('Cuentas-contables') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Plan de cuentas</span>
                        </a>
                        <a href="{{ route('Impuestos') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Tablas de impuestos</span>
                        </a>
                        <a href="{{ route('condicionespago') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Condiciones Pago</span>
                        </a>
                        <a href="{{ route('Mediospagos') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Medios de pago</span>
                        </a>
                        <a href="{{ route('TipoDocumentos') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:font-bold">Tipo Documentos</span>
                        </a>
                        <a href="{{ route('ConceptoDocumentos') }}" class="group relative block px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 overflow-hidden hover:bg-white/25 hover:pl-5 hover:shadow-sm" :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
