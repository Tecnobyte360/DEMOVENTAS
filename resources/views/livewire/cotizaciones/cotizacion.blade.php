...
<div x-data="{
    ...
    <div x-data="{ open: false, src: null, title: '' }"
        ...
        "
        x-cloak>
        <div x-show="open" x-transition.opacity class="fixed inset-0 z-[200] flex items-center justify-center"
            @keydown.escape.window="open = false">
            <div class="absolute inset-0 bg-black/70" @click="open = false"></div>

            <div
                class="relative z-10 max-w-4xl w-[92vw] max-h-[92vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="p-3 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                    <img :src="src" :alt="title || 'Imagen de producto'"
                        class="max-h-[82vh] w-auto object-contain rounded-xl">
                </div>
            </div>
        </div>
    </div>
    ...
    <section
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                ...
                <div>
                    <div class="flex items-center gap-3">
                        <div
                            class="h-11 w-11 rounded-2xl grid place-items-center bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-200">
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-2">
                        ...
                        <span
                            class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px]
        ...
        <section class="p-6 md:p-8 border-b border-gray-100 dark:border-gray-800" aria-label="Datos de la cotización">
                ...
                <section>
                    ...
                    <select wire:model.live="socio_negocio_id"
                        ...
                        @foreach ($clientes as $c)
                            <option value="{{ $c->id }}">{{ $c->razon_social }}@if (!empty($c->nit))
                                    ({{ $c->nit }})
                                @endif
                            </option>
                        @endforeach
            ...
            <div class="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <section>
                    ...
                    <input type="text" placeholder="Ej: Contado, 30 días..."
                ...
                <section>
                    ...
                    <input type="text" placeholder="Ej: General, Mayorista..."
            ...
            <div class="mt-6">
                ...
                <textarea rows="3" wire:model.live.debounce.350ms="notas"
        ...
        <section class="p-6 md:p-8" aria-label="Líneas de la cotización">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <h2 class="text-lg md:text-xl font-extrabold text-gray-900 dark:text-white flex items-center gap-3">
                    <span
                        class="inline-grid place-items-center w-9 md:w-10 h-9 md:h-10 rounded-xl bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-200">
                        2
                    </span>
                    Agrega productos
                </h2>

                <button type="button" wire:click="addLinea" wire:loading.attr="disabled" wire:target="addLinea"
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-gray-800 overflow-x-auto shadow"
                            ...
                            <tr wire:key="cot-linea-{{ $i }}" class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        <button type="button" wire:click="addLinea" wire:loading.attr="disabled"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-4 py-10 text-center text-gray-500 dark:text-gray-400">
                                    No hay líneas. Usa
                                    <button type="button" class="text-violet-600 hover:underline font-semibold"
                                        wire:click="addLinea">
                                        + Línea
                                    </button>.
                                </td>
        ...
        <footer
            ...
            <div class="px-4 md:px-8 py-4">
                <div class="grid grid-cols-1 xl:grid-cols-12 gap-4 items-center">
                    ...
                    {{-- Total --}}
                    <div
                        class="xl:col-span-4 flex flex-wrap items-center gap-2 text-sm md:text-base text-gray-700 dark:text-gray-300">
                        ...
                        <div class="flex flex-wrap justify-end gap-2">
                            ...
                            @if ($cotizacion && !empty($cotizacion->id))
                                <button type="button" wire:click="actualizar" wire:loading.attr="disabled"
                                    wire:target="actualizar" @disabled(!$habilitarActualizar)
        ...
        document.addEventListener('livewire:init', () => {
            ...
            Livewire.on('sync-productos-tomselect', (payload) => {
                ...
                lineas.forEach((l, i) => {
                    ...
                    const ts = createTomSelect(el);
                    if (!ts) return;

                    const productoId = l?.producto_id ? String(l.producto_id) : '';
                    const productoNombre = l?.producto_nombre || l?.nombre || '';
