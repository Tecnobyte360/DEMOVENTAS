...
<section
    ...
    <section class="p-6 md:p-8 border-b border-gray-100 dark:border-gray-800"
        aria-label="Datos de la nota crédito (compra)">
        <header class="mb-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <section>
                ...
                <select wire:key="proveedor-select-{{ $socio_negocio_id ?? 'x' }}"
            ...
            <section class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model.debounce.300ms="motivo"
                        placeholder="Devolución proveedor, descuento, error…"
                        class="w-full h-12 md:h-14 px-4 rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-4 focus:ring-violet-300/60">
                </div>
            </section>
        </div>
        ...
        <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <section>
                <label
                    ...
                    de compra a afectar (opcional)</label>
                ...
                <select wire:model.live.number="factura_compra_id"
            ...
            <section>
                ...
                @php
                    ...
                    $tieneSel =
                        $selectedId &&
                        ($cuentasCXP->contains('id', $selectedId) || $cuentasCaja->contains('id', $selectedId));
                    $opActual =
        ...
        <div class="mt-6">
            ...
            <label class="inline-flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                <input type="checkbox" wire:model="descontar_inventario"
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800"
                    ...
                    @forelse($lineas as $i => $l)
                        ...
                        <tr wire:key="linea-compra-{{ $i }}-{{ $lineas[$i]['producto_id'] ?? 'x' }}-{{ $lineas[$i]['bodega_id'] ?? 'x' }}"
