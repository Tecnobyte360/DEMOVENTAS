                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                    @forelse($items as $f)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40" wire:key="fc-{{ $f->id }}">
                            <td class="px-4 py-3">{{ \Illuminate\Support\Carbon::parse($f->fecha)->format('Y-m-d') }}
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                ...
                                @endphp
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs font-semibold {{ $chip }}">{{ ucfirst($f->estado) }}</span>
                            </td>
