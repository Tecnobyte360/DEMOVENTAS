...
>
  ...
  <div x-show="open" 
                        ...
                        <a href="{{ route('notascreditoclientes') }}" 
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:text-[#1a1a1a] group-hover:font-bold">Nota crédito de ventas</span>
                        </a>
                         <a href="{{ route('abrircaja') }}" 
                           ...
                           :style="`color: ${fgMuted}`">
                            <div class="absolute left-0 top-0 bottom-0 w-0.5 bg-white/0 group-hover:bg-white transition-all duration-300"></div>
                            <span class="transition-all duration-200 group-hover:text-[#1a1a1a] group-hover:font-bold">Apertura de caja</span>
                        </a>
                    </div>
