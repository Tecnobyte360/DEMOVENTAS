...
<body class="h-full overflow-hidden font-inter antialiased bg-white text-slate-700 dark:bg-slate-950 dark:text-slate-300">
    <main class="relative h-[100dvh] overflow-hidden isolation-isolate flex items-center">
        ...
        <div class="pointer-events-none absolute inset-0">
            ...
            <div class="absolute -top-40 -left-40 h-[32rem] w-[32rem] rounded-full bg-[#132742]/[0.08] blur-[120px]"></div>
            <div class="absolute top-1/3 -right-40 h-[34rem] w-[34rem] rounded-full bg-[#132742]/[0.06] blur-[140px]"></div>
            ...
            <div class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent dark:via-white/10"></div>
        </div>

        <div class="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div class="py-4 sm:py-6 lg:py-8">
                <!-- Card WOW: BLANCA, flotando -->
                <div class="grid grid-cols-1 overflow-hidden rounded-[2.75rem]
                    ...
                    <div class="relative flex items-center justify-center p-6 sm:p-10">
                        ...
                        <div class="pointer-events-none absolute inset-0 bg-gradient-to-b from-white via-white/95 to-white/80 dark:from-white/10 dark:via-white/5 dark:to-transparent"></div>

                        <!-- borde interno ultra sutil -->
                        <div class="pointer-events-none absolute inset-0 ring-1 ring-[#132742]/[0.06] dark:ring-white/10"></div>
                    ...
                    <div class="relative hidden lg:flex items-center justify-center p-10">
                        ...
                        <div class="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-sky-400/20 blur-[140px]"></div>
                        ...
                        <div class="relative flex flex-col items-center text-center">
                            <div class="group relative">
                                <div class="absolute -inset-6 rounded-[2.5rem] bg-white/10 blur-2xl opacity-70 transition group-hover:opacity-100"></div>

                                <div class="relative rounded-[2.5rem] bg-white/10 ring-1 ring-white/20 p-4 shadow-2xl">
                                    <img
                                        src="{{ asset('images/lolo.jpeg') }}"
                                        alt="tecnobyte360"
                                        class="w-[18rem] xl:w-[22rem] rounded-2xl shadow-xl transition duration-500 group-hover:scale-[1.02]"
                                        loading="lazy"
                                    />
                                </div>
                            </div>
