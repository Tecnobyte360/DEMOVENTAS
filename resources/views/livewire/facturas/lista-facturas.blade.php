    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <select wire:model="estado"
                class="px-3 py-2 rounded-xl border border-gray-200/70 dark:border-gray-700
                       bg-gray-50 dark:bg-gray-800/70 text-sm text-gray-700 dark:text-gray-100
      ...
      <div class="relative w-full md:w-80">
        ...
        <input type="text"
               ...
               class="pl-9 pr-3 py-2 w-full rounded-xl border border-gray-200/70 dark:border-gray-700
                      bg-gray-50 dark:bg-gray-800/70 text-sm text-gray-700 dark:text-gray-100
                      placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600"
  ...
  <div class="overflow-x-auto rounded-3xl border border-gray-200/70 dark:border-gray-800 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md shadow-xl">
    <table class="min-w-full text-xs sm:text-sm text-gray-700 dark:text-gray-100">
      <thead class="bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 text-[11px] sm:text-xs uppercase tracking-wider text-gray-600 dark:text-gray-300">
        <tr>
          <th class="p-2 sm:p-3 text-left font-semibold">Prefijo</th>
          <th class="p-2 sm:p-3 text-left font-semibold">Número</th>
          <th class="p-2 sm:p-3 text-left font-semibold">Fecha</th>
          <th class="p-2 sm:p-3 text-left font-semibold">Cliente</th>
          <th class="p-2 sm:p-3 text-right font-semibold">Subtotal</th>
          <th class="p-2 sm:p-3 text-right font-semibold">Impuestos</th>
          <th class="p-2 sm:p-3 text-right font-semibold">Total</th>
          <th class="p-2 sm:p-3 text-left font-semibold">Estado</th>
          <th class="p-2 sm:p-3 text-left font-semibold">Acciones</th>
        </tr>
      </thead>
            ...
            <td class="p-2 sm:p-3 whitespace-nowrap">
              <div class="flex items-center gap-1.5 sm:gap-2">
                ...
                <button wire:click="abrirMapa({{ $f->id }})"
                        class="px-2 py-1.5 bg-amber-500 text-white rounded-md" title="Ver relaciones">
