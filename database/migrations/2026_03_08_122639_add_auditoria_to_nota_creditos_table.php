...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('nota_creditos', function (Blueprint $table) {
            ...
            $table->foreignId('emitido_por_id')->nullable()->after('actualizado_por_id');
            $table->timestamp('emitido_en')->nullable()->after('emitido_por_id');

            $table->foreignId('anulado_por_id')->nullable()->after('emitido_en');
        ...
        Schema::table('nota_creditos', function (Blueprint $table) use ($driver) {
            ...
            if ($driver === 'mysql') {
                ...
                $table->foreign('emitido_por_id')
                    ->references('id')->on('users')->nullOnDelete();

                $table->foreign('anulado_por_id')
                    ->references('id')->on('users')->nullOnDelete();
