...
@if($showPreview && $previewId)
  <div
    ...
    {{-- Contenedor --}}
    <div class="relative mx-auto max-w-[98vw] w-[98vw] h-[98vh] mt-[1vh] bg-white dark:bg-gray-900 rounded-lg shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-800">
