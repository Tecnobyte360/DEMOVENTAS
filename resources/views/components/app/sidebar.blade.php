<div class="min-w-fit">
    ...
    <div
        ...
        x-data="{
            ...
            setup(bg){
                ...
                if(this.isLight){
                    ...
                    this.fg = '#FFFFFF';
                    this.fgMuted = 'rgba(255,255,255,.70)';
                    this.fgHover = '#FFFFFF';
                }
            }
        }"
        ...
        :style="`
            background: linear-gradient(180deg, {{ $empresaActual?->color_primario }} 0%, {{ $empresaActual?->color_primario }}f5 100%);
            --sidebar-fg: ${fg};
            ...
            <div class="mb-3 lg:hidden lg:sidebar-expanded:block 2xl:block">
                <div class="group flex items-center gap-3 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-200 cursor-pointer">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium truncate" :style="`color: ${fg}`">Stiven Madrid</p>
                        <p class="text-xs truncate" :style="`color: ${fgMuted}`">stivenmadrid6@gmail.com</p>
                    </div>
                </div>
            </div>
