  ...
  @endforeach
      ...
      <section class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="text" wire:model.debounce.300ms="motivo" placeholder="Devolución, descuento, bonificación…" class="w-full h-12 md:h-14 px-4 rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-4 focus:ring-violet-300/60">
        </div>
      </section>
    </div>
          ...
          @forelse($lineas as $i => $l)
            ...
            >
              ...
              <td class="px-4 py-3 min-w-[260px]">
                ...
                <div class="space-y-1">
                  <select
                    wire:model.number="lineas.{{ $i }}.cuenta_ingreso_id"
