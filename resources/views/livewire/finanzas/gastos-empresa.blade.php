    ...
    <section class="bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 p-8 rounded-3xl shadow-2xl space-y-8">
        ...
        <div class="mt-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
                <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-300 flex items-center gap-2">
                ...
                <div class="relative w-full md:w-[420px]">
                    ...
                    <input
                        ...
                        placeholder="Buscar por documento, ruta, tipo, concepto, observación, monto o fecha..."
                        class="w-full pl-10 pr-4 py-2.5 rounded-2xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm text-gray-800 dark:text-gray-100 placeholder:text-gray-400 focus:ring-2 focus:ring-violet-500 shadow-sm"
                    >
                </div>
            </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-6 text-center text-gray-500 dark:text-gray-400 text-sm italic">
                                        ...
                                        No hay gastos registrados con el filtro o búsqueda seleccionada.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
